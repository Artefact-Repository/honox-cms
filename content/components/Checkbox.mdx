...
The `Checkbox` component is a form control that allows users to toggle between binary choices (checked or unchecked) and indeterminate states. Fully optimised for the page builder, the component supports standard browser behaviors and can be customised with state conditions (such as invalid and disabled states) and accented design themes.

...
This component is available as a `menu` block in the [Page Builder](/docs/PageBuilder) (`content/pages/*.json`) — the CMS block is labelled "Menu" but renders through this `Dropdown` component:

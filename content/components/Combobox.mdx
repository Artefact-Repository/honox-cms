...
The **Combobox** component is fully integrated as an interactive `combobox` block in the **Page Builder**, allowing content authors and developers to easily configure input labels, placeholders, pre-defined item lists, and interaction settings directly within the CMS.

***

# Usage via CMS Page Builder (JSON)

These examples illustrate how content editors bind and structure interactive combobox components inside the JSON page schemas (`content/pages/*.json`).

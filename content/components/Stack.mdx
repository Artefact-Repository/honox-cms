...
The **Stack** component is fully integrated as a `stack` block inside the **Page Builder**, allowing content authors and developers to recursively nest other layout blocks and customise responsive alignment rules directly within the CMS.

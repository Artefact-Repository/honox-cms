...
The **Icon** component is fully integrated as an `icon` block inside the **Page Builder**, enabling Sveltia CMS managers to inject custom vector paths, customise viewports, and alter scale settings directly inside page layouts.

...
- **Unified Event Delegation:** Opening and closing interactions, along with close-on-click-outside and escape-key handling, are delegated cleanly from a central listener on the popover's root element. This minimises client-side event binding.

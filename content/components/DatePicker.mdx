...
An interactive form control that combines a text input field with a popup calendar overlay. It supports single-date pickers, date range selections, multi-select toggles, customised calendar boundaries, localised weekday headers, and keyboard navigation.

...
| --- | --- | --- |
| `accept` | `string \| string[] \| Record<string, string[]>` | Accepted file types — a MIME string, a list, or a MIME→extensions record. Normalized to the native `accept` attribute. |

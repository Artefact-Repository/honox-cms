  ...
  <div style={{ width: "100%", maxWidth: "600px" }}>
    <Tabs defaultValue="profile" interactive variant="enclosed" size="sm">
      ...
      <Tabs.Content value="profile">
        Manage personal information, billing details, and customised regional preferences.
      </Tabs.Content>
  ...
  "items": [
    {
      ...
      "content": [
        {
          "type": "text",
          "content": "Manage personal information, billing details, and customised regional preferences."
        }
      ]
    },
    {

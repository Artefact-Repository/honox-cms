...
- **Server-Side Rendered Icons:** To prevent hydration mismatch warnings and optimise asset delivery, the semantic `AlertIcon` is dynamically compiled into an inline, highly optimised SVG depending on the chosen `status` prop.

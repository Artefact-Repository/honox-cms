...
The **Grid** component is also fully integrated as a `grid` block in the **Page Builder**, allowing content authors and developers to easily construct responsive structures, card lists, and side-by-side controls directly within the CMS.

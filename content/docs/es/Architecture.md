...
3. **Registro del selector de idioma:** Registra el código de locale y su nombre legible por humanos en `ALL_LOCALES` y `LOCALE_NAMES` dentro de `app/lib/i18n.ts`.

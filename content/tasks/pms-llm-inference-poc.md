...
4. **Dawn Metal ComputePipeline Compiler Error (macOS/Intel HD Graphics):**
   - **Error Signature:** `Error creating pipeline state Compiler encountered an internal error ... While initializing [ComputePipeline] at InitializeImpl (ComputePipelineMTL.mm:84)`.
